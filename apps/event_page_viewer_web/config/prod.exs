...
# EventPageViewer.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :event_page_viewer_web, EventPageViewer.Web.Endpoint,
  ...
  http: [port: 8080],
  url: [host: "188.166.255.184", port: 8080],
...
# start per endpoint:
#
#     config :event_page_viewer_web, EventPageViewer.Web.Endpoint, server: true
#
